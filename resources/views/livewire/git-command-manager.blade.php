<div class="h-full flex flex-col p-6 space-y-6">
        ...
        @if($directory)
            <div class="flex space-x-4 w-2/3 justify-end items-center">
                ...
                <div class="bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 text-gray-300 flex items-center min-w-0 max-w-xs"
                    ...
                    <span class="truncate block font-mono text-xs">{{ basename($directory) }}</span>
                </div>
    ...
    @if(!$directory)
        ...
        <div class="max-w-4xl mx-auto w-full flex-1 overflow-auto">
                    ...
                    @foreach($recentRepos as $repo)
                        <div wire:click="openRecent('{{ $repo['path'] }}')" 
                            ...
                            <div class="mt-auto pt-2 flex items-center justify-between text-xs text-gray-500">
                                ...
                                <span class="group-hover:translate-x-1 transition-transform text-indigo-500 font-medium">Open Operations &rarr;</span>
                            </div>
                        </div>
                    @endforeach
                </div>
            @else
                <div class="text-center py-12 border-2 border-dashed border-gray-700 rounded-xl bg-gray-800/50">
                    ...
                    <p class="text-gray-500 mt-1">Open a repository to start performing operations</p>
                </div>
            @endif
        </div>
    @else
        ...
        <div wire:loading.flex
            ...
            <div class="flex flex-col items-center p-8 bg-gray-800 rounded-xl border border-gray-700 shadow-2xl space-y-4">
                ...
                <div class="text-center">
                    <h3 class="text-lg font-bold text-white">Running Git Operation</h3>
                    <p class="text-gray-400 text-sm mt-1">Please wait while the command executes...</p>
                </div>
            </div>
        </div>
    @endif
